        ...
        <div>
            ...
            <div class="flex flex-col gap-y-5 card mt-5 p-5">
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        <div>
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#082F49]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#082F49</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#450A0A]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#450A0A</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#431407]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#431407</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#451A03]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#451A03</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#422006]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#422006</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#1A2E05]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#1A2E05</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#052E16]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#052E16</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#022C22]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#022C22</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#042F2E]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#042F2E</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#083344]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#083344</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#172554]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#172554</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#1E1B4B]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#1E1B4B</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#2E1065]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#2E1065</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#3B0764]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#3B0764</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#4A044E]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#4A044E</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#500724]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#500724</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#4C0519]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#4C0519</small>
                            </div>
            ...
            <div class="flex flex-col gap-y-5 card mt-5 p-5">
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#030712]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#030712</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#020617]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#020617</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#09090B]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#09090B</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#0A0A0A]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#0A0A0A</small>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="grid grid-cols-6 xl:grid-cols-11 gap-5 flex-1">
                        ...
                        <div>
                            <div class="w-full h-10 rounded shadow-inner bg-[#0C0A09]"></div>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-2">
                                <span>950</span>
                                <small>#0C0A09</small>
                            </div>
