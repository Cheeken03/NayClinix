...
<div x-data="{ readonly: true, value: '{{ $value }}' }" wire:ignore.self class="col-lg">
    <div class="form-input mt-4">
        ...
        <div class="input-items default">
            <input x-model="value" x-bind:readonly="readonly" x-bind:class="!readonly && 'input-group-item'" type="text" class="" required autofocus autocomplete="first_name">
        </div>
        <div class="!px-1 input-addon input-addon-append input-group-item !bg-success"
            x-on:click="readonly = !readonly; $wire.saveInput('{{ Str::slug($title, '_') }}', '{{ $model }}', {{ $id }}, value)"
            x-bind:class="readonly && '!hidden'">
